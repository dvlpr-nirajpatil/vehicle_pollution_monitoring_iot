...
void loop() {
  ...
  String documentPath = "Vehicles/RQx67RABPud6gtOjaEyyVBhQpAl1";
  ...
  if (!isnan(sensorValue)) {
    ...
    if (Firebase.Firestore.patchDocument(&fbdo, FIREBASE_PROJECT_ID, "", documentPath.c_str(), content.raw(), "ppm") ) {
      Serial.printf("ok\n%s\n\n", fbdo.payload().c_str());
      } else {
